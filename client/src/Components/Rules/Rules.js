  ...
  return (
    <Box >
      ...
      align="center">
        ...
        <Heading letterSpacing={[3, 7, 8]}
                fontWeight={[520, 600, 600]}
        >RULES AND GUIDELINES</Heading>
        <Divider />
        <Flex 
        ...
        <OrderedList spacing={2}>
          <ListItem>
          Cryptex 2021 consists of 27 levels of generally increasing difficulty. You will receive successive questions upon solving and entering the answer of each level and/or completing the task involved.
          ...
          <ListItem>
            If a question involves typing answers in an answer box, the answers
            should be typed completely in lowercase, without any spaces,
            punctuation, special characters or numerals. The only exception to
            this is when the answer is a numeral greater than 1000 or when the
            answer is a special character. Examples:
<UnorderedList>
  <ListItem>If your answer is American Pie, type americanpie</ListItem>
<ListItem>If your answer is Just 4 Laughs, type justfourlaughs</ListItem>
<ListItem>If your answer is 42069, type 42069</ListItem>
          ...
          <ListItem>
            Any attempt to access levels you have not yet reached or any form of
            attack on the servers will result in disqualification.
          </ListItem>
      ...
      <Flex flexDirection="column"
        ...
        <UnorderedList spacing={2}>
          ...
          <ListItem>
            Reverse searching images might help you in certain cases. Extensions
            such as Huntress helps.
          </ListItem>
          ...
          <ListItem>
            ...
            with a certain approach, do consider that you might be on the wrong
            train of thought.{" "}
          </ListItem>

          <ListItem>
            On the other hand, it could be that the answer is ‘colour’ when you
            have been trying ‘color’. Check for alternate spelling, names and
